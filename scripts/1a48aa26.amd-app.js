...
define('models_experiments',["backbone"], function(Backbone) {
  ...
  return Models.Experiments = (function(_super) {
    ...
    Experiments.prototype.path = function(method) {
      return "/" + window.location.pathname + "/experiments.json";
    };
...
define('view_application',["backbone"], function(Backbone) {
...
define('app-router',["backbone", "models_experiments", "view_application"], function(Backbone, Experiments, ApplicationView) {
